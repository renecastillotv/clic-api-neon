-- ================================================================
-- MIGRACIÓN: Agregar código público a perfiles_asesores
-- Ejecutar en Neon PostgreSQL
-- ================================================================

-- Agregar columna codigo si no existe
ALTER TABLE perfiles_asesores ADD COLUMN IF NOT EXISTS codigo VARCHAR(20) UNIQUE;

-- Crear índice para búsqueda rápida por código
CREATE INDEX IF NOT EXISTS idx_perfiles_asesores_codigo ON perfiles_asesores(codigo);
...
-- Comentario
COMMENT ON COLUMN perfiles_asesores.codigo IS 'Código público único del asesor para tracking (ej: JUA-123)';
